  ...
  const generatePDF = async () => {
    const html = `
      <html>
        <head>
          <style>
            body { font-family: 'Helvetica'; padding: 40px; color: #1a1a2e; }
            ...
            .section-title { font-size: 20px; font-weight: bold; color: #1a1a2e; margin-bottom: 15px; background: #f0eeff; padding: 8px 15px; border-left: 5px solid #6C63FF; }
            .grid { display: flex; flex-wrap: wrap; gap: 20px; }
            .stat-box { flex: 1; min-width: 150px; background: #f8fafc; padding: 15px; border-radius: 10px; }
            .stat-label { font-size: 12px; color: #64748b; margin-bottom: 5px; text-transform: uppercase; }
        ...
        <body>
          <div class="header">
            <h1>LifeTracker Summary Report</h1>
            <div class="meta">Analysis Period: ${period} | Generated: ${new Date().toLocaleDateString()}</div>
          </div>
          ...
          <div class="section">
            ...
            <div class="grid">
              <div class="stat-box">
                ...
                <div class="stat-value">Rs. ${totalIncome.toLocaleString()}</div>
              </div>
              <div class="stat-box">
                <div class="stat-label">Total Expenses</div>
                <div class="stat-value">Rs. ${totalExpense.toLocaleString()}</div>
              </div>
              <div class="stat-box">
          ...
          <div class="section">
            <div class="section-title">Productivity & Tasks</div>
            <div class="grid">
              <div class="stat-box">
              ...
              <div class="stat-box">
                ...
                <div class="stat-value">${taskCompletionRate.toFixed(0)}%</div>
              </div>
            </div>
          </div>
          ...
          <div class="section">
            ...
            <div class="grid">
              <div class="stat-box">
                ...
                <div class="stat-value">${totalActivityMin}m</div>
              </div>
              <div class="stat-box">
                <div class="stat-label">Water Intake</div>
                <div class="stat-value">${data.health.reduce((acc, curr) => acc + (curr.waterIntake || 0), 0)}ml</div>
              </div>
              <div class="stat-box">
                <div class="stat-label">Sleep Avg</div>
          ...
          <div class="section">
            <div class="section-title">Skills & Learning</div>
            <div class="grid">
              <div class="stat-box">
          ...
          <div class="footer">
            Report generated by LifeTracker Intelligence Engine.<br/>
            &copy; 2026 LifeTracker Inc. All rights reserved.
          </div>
        </body>
      </html>
    `;
    ...
    try {
      ...
      await Sharing.shareAsync(uri, { 
        ...
        dialogTitle: 'Download Summary Report',
        UTI: 'com.adobe.pdf' 
      });
    } catch (error) {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
      ...
      <View style={styles.reportsGrid}>
        ...
        <TouchableOpacity style={styles.downloadCard} onPress={generatePDF}>
          <View style={styles.downloadContent}>
            <View style={styles.downloadIcon}>
              <Ionicons name="document-text" size={24} color="#fff" />
            </View>
            <View style={{ flex: 1 }}>
              <Text style={styles.downloadTitle}>Download Summary Report</Text>
              <Text style={styles.downloadSubtitle}>Generate a detailed PDF analysis of your performance.</Text>
            </View>
